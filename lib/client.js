...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const PANEL_FLAT_ATTRIBUTE = "data-dwa-panel-flat";
		/** Attribute that frosts the dim mask behind an open dialog. */
		const MASK_ATTRIBUTE = "data-dwa-mask";
